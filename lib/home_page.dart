...
class _HomePageUIState extends State<HomePageUI> {
  ...
  Future<void> _showPersonDialog({
    ...
    final rawType = person?['type']?.toString().trim().toLowerCase();
    final currentType = rawType == 'elderly' ? 'elderly' : 'baby';
        ...
        builder: (dialogContext) {
          return StatefulBuilder(
            builder: (statefulContext, setDialogState) {
              final isDark =
                  Theme.of(statefulContext).brightness == Brightness.dark;
              ...
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: avatarGradient.last.withValues(
